...
class CreateRequestRoomReviewL1Screen extends StatefulWidget {
  const CreateRequestRoomReviewL1Screen({Key? key}) : super(key: key);

  @override
  State<CreateRequestRoomReviewL1Screen> createState() =>
      _CreateRequestRoomReviewL1ScreenState();
}

class _CreateRequestRoomReviewL1ScreenState
    extends State<CreateRequestRoomReviewL1Screen> {
  ...
  void _submitAction() {
    if (_form.currentState!.validate()) {
      ...
      _requestRoomBloc.add(RequestRoomReviewL1Create(requestRoom: requestRoom));
    }
  }
  ...
  void _requestRoomListener(
    ...
    if (state is RequestRoomReviewL1CreateSuccess ||
  ...
  Widget build(BuildContext context) {
    return BlocListener<RequestRoomReviewL1Bloc, RequestRoomReviewL1State>(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Create RequestRoomReviewL1')),
        body: Form(
          key: _form,
          child: ListView(
