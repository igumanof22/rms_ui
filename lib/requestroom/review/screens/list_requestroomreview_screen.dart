      ...
      body: Column(
        children: [
          TextField(
            ...
            onSubmitted: (value) {
              _requestRoomReviewBloc
                  .add(RequestRoomReviewFetch(requestId: value));
            },
          ),
          BlocBuilder<RequestRoomReviewBloc, RequestRoomReviewState>(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: () =>
                              Get.to(() => DetailRequestRoomReviewScreen(
                                    id: requestRoom.id!,
